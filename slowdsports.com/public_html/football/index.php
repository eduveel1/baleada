				...
				<nav id="navbar" data-uk-navbar="mode: click;">
					...
					<div class="uk-navbar-left nav-overlay uk-visible@m">
						<ul class="uk-navbar-nav">
                            ...
                            <li class="uk-active"><a class="nav-text" href="http://slowdsports.com/football/">Football</a></li>
    ...
    <div class="uk-child-width-expand@s uk-text-center" uk-grid>
       <!--CHANNEL-->
        ...
        <div class="uk-card uk-card-default uk-card-body">
            ...
            <div class="uk-card-badge uk-label badge-football">Football</div>
            <img style="width: 45px;" class="channel-img" src="https://cdn.worldvectorlogo.com/logos/nfl-network-logo.svg" alt="">
            <h3 class="uk-card-title">NFL Network</h3>
            <p>NFLN is an American sports-oriented pay television network. Owned by the National Football League.</p>
            <p class="channel-owner">
            <i>Owner: </i>
            </p>
            <a href="http://slowdsports.com/tv/nfln.php" class="uk-button uk-button-default" type="button">Watch <i>HD</i></a>
        </div>
		...
		<div id="offcanvas-nav" data-uk-offcanvas="flip: true; overlay: true">
			<div class="uk-offcanvas-bar uk-offcanvas-bar-animation uk-offcanvas-slide">
				...
				<ul class="uk-nav uk-nav-default">
                    ...
                    <li class="uk-active"><a class="nav-text" href="http://slowdsports.com/football/">
