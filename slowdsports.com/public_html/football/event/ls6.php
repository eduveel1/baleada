...
<html>
    ...
    <li>
        ...
        <hr>
        <div class="uk-accordion-content">
            <p> <iframe sandbox="allow-same-origin allow-scripts" allowfullscreen="" width="580" height="360" scrolling="no" frameborder="0" marginwidth="0" marginheight="0" allowtransparency="false" src="http://slowdsports.com/tv/channels/los/football/6.php"></iframe> </p>
        </div>
    </li>
</ul>
       </center>
