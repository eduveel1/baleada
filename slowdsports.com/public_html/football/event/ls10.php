...
<html>
				...
				<nav id="navbar" data-uk-navbar="mode: click;">
					...
					<div class="uk-navbar-left nav-overlay uk-visible@m">
						<ul class="uk-navbar-nav">
							<li><a class="nav-text" href="soccer/">Soccer</a></li>
    ...
    <p> <i class="fa fa-info-circle"></i> The signal will be available 30 minutes before the start of the event.</p>
      ...
      <!--AD--
      <center>
      <img src="https://image.freepik.com/free-vector/video-media-player-design_114579-839.jpg" style="align-items: center; align-content: center;" alt="">
      </center>
    ...
    <li>
        ...
        <div class="uk-accordion-content">
            <p><img src="https://image.freepik.com/free-vector/video-media-player-design_114579-839.jpg" style="align-items: center; align-content: center;" alt=""></p>
        </div>
    </li>
    <li>
        ...
        <hr>
        <div class="uk-accordion-content">
            <p> <iframe sandbox="allow-same-origin allow-scripts" allowfullscreen="" width="580" height="360" scrolling="no" frameborder="0" marginwidth="0" marginheight="0" allowtransparency="false" src="http://slowdsports.com/tv/channels/los/football/10.php"></iframe> </p>
        </div>
    </li>
</ul>
       </center>
		...
		<div id="offcanvas-nav" data-uk-offcanvas="flip: true; overlay: true">
			<div class="uk-offcanvas-bar uk-offcanvas-bar-animation uk-offcanvas-slide">
				...
				<ul class="uk-nav uk-nav-default">
					...
					<li class=""><a class="nav-text" href="http://slowdsports.com/soccer/">
