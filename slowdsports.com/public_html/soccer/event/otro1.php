...
<html>
    ...
    <li>
        ...
        <div class="uk-accordion-content">
            <div style="width: 76%; left: -23px; margin-left: 3%; margin-bottom: -40%; position: relative; top: 15px; bottom: -30px; z-index: 1; " class="frame">

<iframe allowfullscreen="" sandbox="allow-same-origin allow-scripts" width="100%" height="400" scrolling="no" frameborder="0" marginwidth="0" marginheight="0" allowtransparency="false" src="http://simple-stream.net/canal1?ticos"></iframe>
</div>
        </div>
    </li>
</ul>
