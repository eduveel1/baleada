      ...
      <script>
         window.onload = function() {
             var player = new Clappr.Player({
                 source: window.atob("aHR0cDovL2xpdmUtZWRnZTAxLnRlbGVjZW50cm8ubmV0LmFyL2xpdmUvc21pbDp0bHguc21pbC9jaHVua2xpc3RfdzE1MjcwNDM0MzVfYjE4MjgwMDBfc2xlbmcubTN1OD9lYW1vZ3JhdGlzP0VudHJldGVuaW1pZW50by5tM3U4"),
                 parentId: '#player',
                 mimeType: 'audio/mpeg',
