      ...
      <script>
         window.onload = function() {
             var player = new Clappr.Player({
                 source: window.atob("aHR0cHM6Ly9jZG5hcGkua2FsdHVyYS5jb20vcC8yMjE2MDgxL3NwLzIyMTYwODEwMC9wbGF5TWFuaWZlc3QvZW50cnlJZC8xX2YxOWVldWx6L2Zvcm1hdC9hcHBsZWh0dHAvcHJvdG9jb2wvaHR0cC91aUNvbmZJZC8yODQyODc1MS9hLm0zdTg="),
                 parentId: '#player',
                 mimeType: 'audio/mpeg',
