      ...
      <script>
         window.onload = function() {
             var player = new Clappr.Player({
                 source: window.atob("aHR0cHM6Ly9mY2JsaXZlLWEuYWthbWFpemVkLm5ldC9kYy0xL2xpdmUvaGxzL3AvMjA5MDYyMS9lLzFfdHM2ZDVjNHQvc2QvNjAwMC90L3dQV3VqN1BKYlFqNk1iSGpiLTdQekEvbWFzdGVyLm0zdTg="),
                 parentId: '#player',
                 mimeType: 'audio/mpeg',
