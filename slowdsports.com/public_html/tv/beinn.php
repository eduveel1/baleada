...
<html>
    ...
    <!--HEADER-->
				...
				<nav id="navbar" data-uk-navbar="mode: click;">
					...
					<div class="uk-navbar-left nav-overlay uk-visible@m">
						<ul class="uk-navbar-nav">
							<li class="uk-"><a class="nav-text" href="soccer/">Soccer</a></li>
      ...
      <h1 class="uk-heading-bullet">Bein Sports Ñ</h1>
      <hr>
    ...
    <li>
        ...
        <hr>
        <div class="uk-accordion-content">
            <p> <iframe width="100%" height="500" scroling="no" class="myframe" src="//espn-live.stream/stream/69175.html" frameborder="0"></iframe> </p>
        </div>
    </li>
</ul>
       </center>
