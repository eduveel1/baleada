			...
			<div class="uk-container">
				<nav id="navbar" data-uk-navbar="mode: click;">
                    ...
                    <ul class="uk-navbar-nav nav-right-custom">
					    <li class="uk-active"><a class="nav-text" href="http://slowdsports.com/golf/">Golf</a></li>
    ...
    <div class="uk-child-width-expand@s uk-text-center" uk-grid>
       <!--CHANNEL-->
        ...
        <div class="uk-card uk-card-default uk-card-body">
            ...
            <img style="width: 45px;" class="channel-img" src="https://upload.wikimedia.org/wikipedia/commons/thumb/0/02/Movistar_Golf.svg/1280px-Movistar_Golf.svg.png" alt="">
            <h3 class="uk-card-title">M+ Golf</h3>
            <p>Movistar Golf is a Spanish television own and operated by Telefónica.</p>
            <p class="channel-owner">
            <i>Owner: </i>
            </p>
            <a href="http://slowdsports.com/tv/mgolf.php" class="uk-button uk-button-default" type="button">Watch <i>HD</i></a>
        </div>
		...
		<div id="offcanvas-nav" data-uk-offcanvas="flip: true; overlay: true">
			<div class="uk-offcanvas-bar uk-offcanvas-bar-animation uk-offcanvas-slide">
				...
				<ul class="uk-nav uk-nav-default">
                    ...
                    <li class="uk-active"><a class="nav-text" href="http://slowdsports.com/golf/">
