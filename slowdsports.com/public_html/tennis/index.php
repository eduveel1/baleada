...
<html>
				...
				<nav id="navbar" data-uk-navbar="mode: click;">
					...
					<div class="uk-navbar-left nav-overlay uk-visible@m">
						<ul class="uk-navbar-nav">
                            ...
                            <li class="uk-active"><a class="nav-text" href="http://slowdsports.com/tennis/">Tennis</a></li>
						</ul>
					</div>
    ...
    <div class="uk-child-width-expand@s uk-text-center" uk-grid>
       <!--CHANNEL-->
        ...
        <div class="uk-card uk-card-default uk-card-body">
            ...
            <div class="uk-card-badge uk-label badge-tennis">Tennis</div>
            <img style="width: 45px;" class="channel-img" src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/8c/Tennis_Channel_logo.svg/1200px-Tennis_Channel_logo.svg.png" alt="">
            <h3 class="uk-card-title">Tennis Channel</h3>
            <p>Tennis Channel is an American sports-oriented digital cable and satellite television network.</p>
            <p class="channel-owner">
            <i>Owner: Sports24</i>
            </p>
            <a href="http://slowdsports.com/tv/tennisc.php" class="uk-button uk-button-default" type="button">Watch <i>HD</i></a>
        </div>
  ...
  <hr class="uk-divider-icon">
   ...
   <!--TABLE-->
    <script src="http://slowdsports.com/js/timer2.js"></script><script>t5am();t530am();t6am();t630am();t7am();t730am();t8am();t830am();t9am();t930am();t10am();t1030am();t11am();t1130am();t12am();t1230am();t1pm();t130pm();;t2pm();t230pm();;t3pm();t330pm();;t4pm();t430pm();;t5pm();t530pm();;t6pm();t630pm();;t7pm();t730pm();;t8pm();t830pm();t9pm();t930pm();;t10pm();t1030pm();</script>  
          
       
       <table class="uk-table uk-table-small uk-table-divider">
    <caption>Scheduled - Aug 9 - Aug 10</caption>
    <thead>
        <tr class="center">
    ...
    <tbody>
       ...
       <!--LIGA-->
        <tr class="uk-table table-liga center">
            <td><img src="https://slowdtech.net/api/assets/iraffle/ligas/trans.png" alt="" class="competition nba"></td>
       ...
       <!--MATCH--
        <tr class="center">
            ...
            <td>
            <a href="#" class="uk-button uk-button-default" type="button"><i class="flag es"></i>Watch</a></td>
		...
		<div id="offcanvas-nav" data-uk-offcanvas="flip: true; overlay: true">
			<div class="uk-offcanvas-bar uk-offcanvas-bar-animation uk-offcanvas-slide">
				...
				<ul class="uk-nav uk-nav-default">
                    ...
                    <li class="uk-active"><a class="nav-text" href="http://slowdsports.com/tennis/">
